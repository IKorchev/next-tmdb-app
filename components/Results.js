  ...
  return (
    <>
      <Head>
        ...
        <meta property='og:image:secure_url' content='https://i.ibb.co/gyzY3gh/Moovy.png' />
      </Head>

      <div className='container px-4 sm:px-8 lg:px-24 mx-auto'>
        <h1 className='capitalize text-center p-5'>{genre !== 'TV' ? `${genre} Movies` : `${genre} series`}</h1>
        <div className='grid gap-5 grid-flow-row grid-cols-2 xl:grid-cols-2 2xl:grid-cols-4 mx-auto justify-items-center'>
